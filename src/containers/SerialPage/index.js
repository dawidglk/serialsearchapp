        ...
        <>
          <AppBar position="relative">
            <Toolbar>
              ...
              <Title color="inherit">{serialItem.show.name}</Title>
            </Toolbar>
          </AppBar>
              ...
              <List>
                ...
                <ListItem>
                  <ListItemText
                    primary="NAME"
                    secondary={
                      serialItem.show.name ? serialItem.show.name : "---"
                    }
                  />
                </ListItem>
                <Divider />
                <ListItem>
                  <ListItemText
                    primary="RATING"
                    secondary={
                      serialItem.show.rating.average
                        ? serialItem.show.rating.average
                        : "---"
                    }
                  />
                ...
                <ListItem>
                  {`${
                    serialItem.show.summary
                      ? serialItem.show.summary.replace(/(<([^>]+)>)/gi, "")
                      : "---"
                  }`}
                </ListItem>
              </List>
...
const mapStateToProps = (state, ownProps) => ({
  serial: (state.serials || []).filter(
    ({ show }) => show.id === Number(ownProps.match.params.id)
  ),
});
